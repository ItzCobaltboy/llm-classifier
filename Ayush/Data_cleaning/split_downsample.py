...
for size in ["small", "medium", "original"]:
    for split in ["train", "val", "test"]:
        print(f"Processing split_downsample: {size} | {split}")
        ...
        df_final = downsample(remove_duplicates(split_texts(df)))
        
        out_dir = f"./Dataset_cleaned/split_downsample/Dataset_{size}/{split}"
